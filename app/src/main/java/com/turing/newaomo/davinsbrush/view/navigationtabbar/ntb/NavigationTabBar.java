...
package com.turing.newaomo.davinsbrush.view.navigationtabbar.ntb;
...
import com.turing.newaomo.davinsbrush.view.navigationtabbar.behavior.NavigationTabBarBehavior;
...
public class NavigationTabBar extends View implements ViewPager.OnPageChangeListener {
    ...
    protected final static float DEFAULT_ICON_SIZE_FRACTION = 0.4F;
    protected final static float DEFAULT_TITLE_ICON_SIZE_FRACTION = 0.4F;

//protected final static int DEFAULT_INACTIVE_COLOR = Color.parseColor("#f60025");   // 没有被选中的图片和文字的颜色
    protected final static int DEFAULT_INACTIVE_COLOR = Color.parseColor("#0f8DEE");   // 没有被选中的图片和文字的颜色
    protected final static int DEFAULT_ACTIVE_COLOR = Color.WHITE;      //被选中的图片和文字的颜色
    protected final static int DEFAULT_BG_COLOR = Color.parseColor("#ffffff");  //默认的背景颜色
    ...
    protected final static float TITLE_SIZE_FRACTION = 0.1878F;
...
//            setColor(Color.WHITE);
            setColor(Color.parseColor("#f60025"));
