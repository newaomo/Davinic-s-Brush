package com.turing.newaomo.davinsbrush.fileSelect.fileview;
...
import com.turing.newaomo.davinsbrush.fileSelect.cache.OpenFile;
...
public class FileDisplayActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        init();
        textView3 = (TextView)findViewById(R.id.txt_right_title);
...
//                    EasyPermissions.requestPermissions(FileDisplayActivity.this, "需要访问手机存储权限！", 10086, perms);
//                } else {


                    SharedPreferences sharedPreferences = getSharedPreferences("currentFileShow", MODE_PRIVATE);
                    filePath = sharedPreferences.getString("currentFileView", "");
...
//                }
    ...
    public void init() {
        ...
        if (!TextUtils.isEmpty(path)) {
            ...
            setFilePath("http://www.hrssgz.gov.cn/bgxz/sydwrybgxz/201101/P020110110748901718161.doc");
        }
        Log.d("sssss",path);
        mSuperFileView.show();
    ...
    private void getFilePathAndShowFile(SuperFileView2 mSuperFileView2) {
        ...
        if (getFilePath().contains("http")) {//网络地址要先下载
            ...
            mSuperFileView2.displayFile(new File("/storage/emulated/0/tencent/TIMfile_recv/news_show.docx"));
            Log.d("sssss","/storage/emulated/0/tencent/TIMfile_recv/news_show.docx");
        }
    }
