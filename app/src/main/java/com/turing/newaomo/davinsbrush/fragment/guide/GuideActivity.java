package com.turing.newaomo.davinsbrush.fragment.guide;
...
import com.turing.newaomo.davinsbrush.activity.other.LoginActivity;
    ...
    private void assignViews() {
        ...
        bt_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SharedPreferences sharedPreferences = getSharedPreferences("isFirstGuidePage",MODE_PRIVATE);
