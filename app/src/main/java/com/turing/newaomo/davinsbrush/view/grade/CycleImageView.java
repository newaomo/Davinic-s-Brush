...
public class CycleImageView extends android.support.v7.widget.AppCompatImageView{
    ...
    public CycleImageView(Context context, AttributeSet attrs, int defStyleAttr) {
