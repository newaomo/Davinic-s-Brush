...
public class GenerateProfileActivity extends AppCompatActivity {
    ...
    public void initView(){
        ...
        linearButton = (View)findViewById(R.id.gen_profile_linear_btn);
        linearButton.setVisibility(View.INVISIBLE);

        listViewShare = (HorizontalListView)findViewById(R.id.list_share) ;
        mPhotoView = (PhotoView)findViewById(R.id.image_profile_result_preview);
        mPhotoView.enable();

        btn_edit = (TextView)findViewById(R.id.gen_profile_btn_edit) ;
        btn_save = (TextView)findViewById(R.id.gen_profile_btn_save) ;
        ...
        textViewStep1 = (TextView)findViewById(R.id.gen_profile_text1);
        textViewStep2 = (TextView)findViewById(R.id.gen_profile_text2);
        textViewStep3 = (TextView)findViewById(R.id.gen_profile_text3);
        textViewStep4 = (TextView)findViewById(R.id.gen_profile_text4);
        imageViewResult = (PhotoView) findViewById(R.id.gen_profile_result_image);
        ...
        imageViewWave = (ImageView)findViewById(R.id.gen_profile_wave_image);
...
//    Bitmap image = ((BitmapDrawable)imageViewResult.getDrawable()).getBitmap();
//    MyShareUtil myShareUtil = new MyShareUtil(GenerateProfileActivity.this);
//                myShareUtil.shareImageToQQ(GenerateProfileActivity.this,image);
    ...
    public void saveImage(){
        if (imageViewResult == null){
            Toast.makeText(GenerateProfileActivity.this,"下载出了问题",Toast.LENGTH_SHORT).show();
        }else {
            PictureSaveUtil.getInstance(GenerateProfileActivity.this).saveImageToGallery(imageResult);
        }
    }
    ...
    public void initShare(){
        ...
        listViewShare.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                switch (position){
                    case 0:
                        MyShareUtil.getInstance(GenerateProfileActivity.this).shareImageToQQ(GenerateProfileActivity.this,imageResult);
                        break;
                    case 1:
                        MyShareUtil.getInstance(GenerateProfileActivity.this).shareImageToWeixin(GenerateProfileActivity.this,imageResult);
                        break;
                    case 2:
                        MyShareUtil.getInstance(GenerateProfileActivity.this).shareImageToWeibo(GenerateProfileActivity.this,imageResult);
                        break;
                    case 3:
                        MyShareUtil.getInstance(GenerateProfileActivity.this).shareImageToFaceBook(GenerateProfileActivity.this,imageResult);
                        break;
                    case 4:
                        MyShareUtil.getInstance(GenerateProfileActivity.this).shareImageToOther(GenerateProfileActivity.this,imageResult);
                        break;
