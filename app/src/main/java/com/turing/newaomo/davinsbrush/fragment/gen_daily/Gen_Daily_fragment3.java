...
public class Gen_Daily_fragment3 extends Fragment implements View.OnClickListener {
...
//    private ImageView imageViewFile;
    ...
    public static Gen_Daily_fragment3 newInstance() {
        return new Gen_Daily_fragment3();
    }
...
//Log.i(TAG, "Uri Scheme:" + uri.getScheme());
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        Gen_By_Daily_Activity.isNeedContent = false;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        root = inflater.inflate(R.layout.gen_daily_fragment3, container, false);

        select_from_history = (ImageView)root.findViewById(R.id.daily_select_from_history) ;
        select_from_local = (ImageView)root.findViewById(R.id.daily_select_from_local) ;
        select_from_qq = (ImageView)root.findViewById(R.id.daily_select_from_qq) ;
        select_from_weixin = (ImageView)root.findViewById(R.id.daily_select_from_weixin) ;
        ...
        textViewTitle = (TextView) root.findViewById(R.id.gen_by_daily_title);
        textViewLast = (TextView)root.findViewById(R.id.daily_textview_last3) ;
        textViewSkip = (TextView)root.findViewById(R.id.daily_textview_skip3);
        buttonNext = (Button) root.findViewById(R.id.button_daily_next3);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.daily_textview_last3:
                Gen_By_Article_Activity.viewPager.setCurrentItem(0);
                break;
            case R.id.daily_select_from_history: //查看上次缓存好的界面
                gotoLastActivity();
                break;
            case R.id.daily_select_from_local: //通过Intent查找文件
                gotoSelectActivity();
                break;
            case R.id.daily_select_from_qq: //查看QQ文件夹下的文件
                Intent intent = new Intent(getActivity(), SelectFileFromQQActivity.class);
                startActivityForResult(intent,1);
                break;
            case R.id.daily_select_from_weixin: //查看微信文件夹下的文件
                Intent intent2 = new Intent(getActivity(), SelectFileFromWeixinActivity.class);
                startActivityForResult(intent2,1);
                break;
            case R.id.gen_by_daily_title:        //预览文件
...
//                // }
                break;
            case R.id.button_daily_next3:        //TODO  跳转到下一个界面进行下一步
                saveData();
                Gen_By_Daily_Activity.viewPager.setCurrentItem(2);
                break;
            case R.id.daily_textview_skip3:         //TODO  跳过这一部
                Gen_By_Daily_Activity.viewPager.setCurrentItem(2);
                break;
        }
    }
